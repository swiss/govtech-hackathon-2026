...
The Challenge “[Dashboard electric car charging stations](https://hack.opendata.ch/project/944)” was presented at our GovTech Hackathon in 2023, where this challenge aimed to develop a dashboard to monitor electricity consumption and usage at electric vehicle charging stations in Switzerland. On the respective challenge/project page, you can find more information on the challenge such as the pitch, final presentation or description. Under hack.opendata.ch you can find challenges from past Hackathons.
...
In consultation with the event organizing team, well founded exceptions to these rules are possible. Reach out to hackathon-bk[at]bfh.ch if you need any help making your data available at the Hackathon.
